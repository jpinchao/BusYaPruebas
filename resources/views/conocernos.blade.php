    ...
    <div class="container text-center">
        <div class="row row-cols-2">
            <div class="col" id="DivMision">
                <h3>VISION</h3>
                <p style="font-size: 20px"><strong>En BusYa, nuestra misión es facilitar la vida de las
                    ...
                    desarrollo de comunidades más conectadas y sostenibles.</strong> </p>
            </div>
            ...
            <div class="col" id="DivVision">
                <h3>VISION</h3>
                <p style="font-size: 20px"><strong>En BusYa, imaginamos un mundo donde el transporte público es sinónimo de
            ...
            <div class="col" id="DivPolitica">
                ...
                <li style="font-size: 20px">Privacidad y Seguridad de los Datos: Garantizamos la privacidad y seguridad
                    ...
                    no autorizados. </li>
                <li style="font-size: 20px">Exactitud y Actualización de la Información: Nos comprometemos a proporcionar
